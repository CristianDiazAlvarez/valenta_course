...
En este ejemplo tiene una función que se encarga de codificar una imagen en base64.
Luego, hemos creado un historial de mensajes que incluye un mensaje del sistema que le dice al modelo si pudiera analizar la imagen,
luego adjuntamos la imagen en base64 y finalmente el modelo nos responde con la descripción de la imagen.
"""
    ...
    },
    {
        ...
        "content": [
            ...
            },
            {
                "type": "image_url",
                "image_url": {
                    "url": f"data:image/png;base64,{encode_image_to_base64('./1.png')}"
                }
            }
        ]
    }
